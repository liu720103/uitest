...
def read_excel(sheetname,col):
    # 打开文件
    workBook = xlrd.open_workbook('D:\uitest\source\config.xlsx')
    # 1.获取sheet的名字
    ...
    #print(sheet1Name)
    sheet1_content1 = workBook.sheet_by_name(sheetname)
    cols = sheet1_content1.col_values(col-1)  # 获取第col列内容
    return cols

    # 2. 获取sheet内容
    ## 2.1 法1：按索引号获取sheet内容
    #sheet1_content2 = workBook.sheet_by_index(0) # sheet索引从0开始
...
if __name__ == '__main__':
    read_excel(sheetname="config",col=1)
'''